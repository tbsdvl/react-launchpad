...
Check out a live deployment of react-launchpad <a href="https://focused-morse-f0bd6d.netlify.app/" rel="noopener noreferrer" target="_blank">here</a>
# Installation
...
```my-launchpad-app``` is the name of the new react-launchpad app. You can use any name you like for the app.
...
module.exports = {
  entry: "./src/index.js",
  mode: "development",  // Change to "production", or use an environment variable
  module: {
    rules: [
      {
        test: /\.(js|jsx)$/,
